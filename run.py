...
igv_remote.load_single(sock, sample_gspath, genesymbol="TP53", imgname="testsingle.png")
print("single bam view generated")

# test igv with paired url
tumor_gspath = testdf["NB"][0]
normal_gspath = testdf["TP"][0]
igv_remote.load_pair(sock, tumor_bam=tumor_gspath, normal_bam=normal_gspath, genesymbol="TP53", imgname="testpair.png")
